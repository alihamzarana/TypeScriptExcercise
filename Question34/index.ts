...
// just the name of the pizza.For each pizza you should have one line of 
...
const Pizzas: String[] = ["chicken tikka", "chicken fajita", "pepperoni pizza"];
...
console.log(`I love to eat pizza when I am hungry`);
